...
<section class="mt-5">
    <div class="w-full px-6 grid grid-cols-1 gap-y-6">
        <div class="w-full relative">
            ...
            <div class="absolute bottom-0 z-20 w-3/4 ml-7 mb-7">
                ...
                <a href="#" class="text-white text-sm inline-flex items-center hover:font-bold">
...
<section class="mt-5">
    <div class="bg-custom-gray py-10 px-6 flex flex-col">
        <div class="w-full">
            <p class="text-[#808080] tracking-widest text-xs">ACERCA DE NOSOTROS</p>
            <h3 class="text-2xl text-primary">Facilitamos, diseñamos e implementamos sistemas <span class="font-bold">de gestión de políticas de integridad empresarial.</span></h3>
            <p class="text-sm text-primary mt-5">Emplea metodologías y herramientas de las mejores prácticas internacionales, así como brinda capacitación para apoyar a las empresas a eficientar sus procesos, así como implementar controles para el logro de sus objetivos.</p>
            <div class="mt-7">
        ...
        <div class="w-full mt-10">
            <img src="{{ asset('images/acerca-image.jpg') }}" alt="ACERCA DE NOSOTROS">
        </div>
    </div>
</section>
<section>
    <div class="py-10 px-6" style="background-image: url({{ asset('images/capacitacion-bg.jpg') }})">
        <div class="text-center">
            <h2 class="text-xl text-white">Programas de <span class="font-bold">Capacitación</span></h2>
            <div class="w-32 h-0.5 bg-white mx-auto mt-5"></div>
        </div>
        <div class="w-full mt-10 grid grid-cols-1 gap-y-10">
            <div class="text-center">
                <img class="w-full" src="{{ asset('images/grand-prix-experience.jpg') }}" alt="Grand Prix">
                <h4 class="text-white font-bold mt-3">Grand Prix Experience</h4>
            </div>
            <div class="text-center">
                <img class="w-full" src="{{ asset('images/puppet-challenge.jpg') }}" alt="Grand Prix">
                <h4 class="text-white font-bold mt-3">Puppet Challange</h4>
            </div>
            <div class="text-center">
                <img class="w-full" src="{{ asset('images/lego-experiment.jpg') }}" alt="Grand Prix">
                <h4 class="text-white font-bold mt-3">Lego Experiment</h4>
            </div>
        </div>
