<nav class="flex flex-row items-start w-full fixed">
    <div class="bg-black bg-opacity-50 px-6 py-3 flex flex-row items-center justify-between {{ $menuOpen?'w-1/2':'w-full' }} transform transition-all duration-500 ease-in-out">
        <div>
